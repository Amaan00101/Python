...
celsius = int(input("enter an integer value: "))

def fahrenheit(cel_tem):
    return round((1.8 * cel_tem + 32), 1)

print("The Fahrenheit equivslent of " + str(celsius) + " degrees Celsius is " + str(fahrenheit(celsius)) + ".")
